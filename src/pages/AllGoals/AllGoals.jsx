...
const AllGoals = () => {
  const [goals, setGoals] = useState([
    { id: 1, title: 'Become a Full-Stack Developer', targetDate: '2024-12-31', completed: false },
    { id: 2, title: 'Run a Marathon', targetDate: '2025-05-20', completed: true },
    // Add more goals here
  ]);
      ...
      <div className="bg-darkCharcoal/80 p-8 rounded-xl shadow-lg w-full max-w-5xl backdrop-blur-md">
        ...
        <div className="space-y-6">
          {goals.map((goal) => (
            ...
            >
              <h3 className={`text-xl font-bold ${goal.completed ? 'text-neonPink' : 'text-electricBlue'} mb-2`}>
                {goal.title}
              </h3>
              <div className="flex justify-between items-center">
                <span className="text-cyberYellow">Target Date: {goal.targetDate}</span>
