            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-metall p-4 rounded-lg shadow-md text-center border border-electricBlue">
                  <h3 className="text-lg font-bold text-electricBlue">
                    Total Letters
                  </h3>
                  <p className="text-2xl font-bold text-metallicSilver">
                    {letters.length}
                  </p>
                </div>
                <div className="bg-darkCharcoal p-4 rounded-lg shadow-md text-center border border-neonPink">
                  <h3 className="text-lg font-bold text-neonPink">
                    Total Goals
                  </h3>
                  <p className="text-2xl font-bold text-metallicSilver">
                    {goals.length}
                ...
                <div className="bg-darkCharcoal p-4 rounded-lg shadow-md text-center border border-cyberYellow">
                  <h3 className="text-lg font-bold text-cyberYellow">
                    Completed Goals
                  </h3>
                  <p className="text-2xl font-bold text-metallicSilver">
              ...
              {/* Upcoming Letters */}
              {!isLoading && (
                <ItemSection section="letters" itemlist={letters.slice(0, 3)} />
              )}
              ...
              {!isLoading && (
                <ItemSection
                  section="goals"
                  itemlist={goals.filter((goal) => !goal.done).slice(0, 3)}
                />
              )}
